...
# ===========================================================================
HOST = "lukaadzic"   # shown as  lukaadzic@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "SWE @ C4R"),
    ("kv", "Research", "Agentic systems for statistical genetics"),
    ("kv", "Edu", "Wharton, UPenn"),
    ("kv", "Base", "Philadelphia, PA"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript"),
    ("kv", "Backend", "Python, MongoDB, MATLAB"),
    ("kv", "AI / ML", "NLP, OpenCV, agentic pipelines"),
    ("kv", "Quant", "Financial modeling, algo trading"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Live algo trading system, 22% return in two months"),
    ("bul", "Bubble detection dashboard built on options data"),
    ("bul", "Founded Maritime Penn Club, 100+ members"),
]
