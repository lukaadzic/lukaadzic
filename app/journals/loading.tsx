export default function Loading() {
	return (
		<div className="min-h-screen bg-background text-foreground">
			{/* Header */}
			<header className="flex items-center justify-between px-[117px] pt-8 pb-5">
				<div className="text-[24px] font-medium">lukaadzic</div>
				<div className="text-[16px]">Journals</div>
			</header>
			...
			>
				...
				<div className="p-8">
					<div className="animate-pulse">
						<div className="h-8 bg-foreground/10 rounded mb-6 w-1/3"></div>
