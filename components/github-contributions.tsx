...
export function GitHubContributions({ username }: GitHubContributionsProps) {
  ...
  const generateRealisticContributions = (): ContributionDay[] => {
    ...
    for (let d = new Date(yearAgo); d <= today; d.setDate(d.getDate() + 1)) {
      ...
      if (dayOfWeek >= 1 && dayOfWeek <= 5) {
        ...
        // Weekends: lower chance of contributions
  ...
  const getContributionColor = (level: number): string => {
    switch (level) {
      case 0: return "#161b22"; // GitHub's background color for no contributions
      case 1: return "#0e4429"; // Light green
      case 2: return "#006d32"; // Medium green
      case 3: return "#26a641"; // Darker green
      case 4: return "#39d353"; // Darkest green
    ...
    return (
      <div className="font-mono">
        <div className="flex items-start gap-3 py-3">
          <span className="text-green-400 text-sm mt-0.5 select-none font-bold">❯</span>
          <div className="flex-1 min-w-0">
            ...
            <div className="contributions-scroll overflow-x-auto">
              <div className="inline-grid grid-flow-col gap-1" style={{ gridTemplateRows: 'repeat(7, 1fr)', minWidth: '700px' }}>
    ...
    <div className="font-mono">
      <div className="flex items-start gap-3 py-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {error && (
            <p className="text-yellow-400 text-xs mb-3">{error}</p>
          )}
          ...
          <div className="mb-4 relative">
            <div className="overflow-x-auto no-scrollbar">
              ...
              <div className="absolute left-0 text-xs text-foreground/60 font-mono hidden md:block" style={{ top: '4px' }}>
                ...
                <div className="h-4 flex items-center justify-end pr-1">Wed</div> {/* Wed - 4th square */}
                <div className="h-4"></div> {/* Thu - 5th square */}
                <div className="h-4 flex items-center justify-end pr-1">Fri</div> {/* Fri - 6th square */}
